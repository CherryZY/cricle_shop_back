...
export default {
  ...
  methods:{
	...
	timerTask( attr , total ){
		let totalCount = Math.floor((total/3));
  ...
  mounted(){
  		this.$nextTick(() =>{
  			this.timerTask('orderTotal' ,50);
  			this.timerTask('tadayOrder' ,3);
  			this.timerTask('totalOrderAmount' ,10683);
  			this.timerTask('salesOrder' ,20);
  			this.timerTask('shopOrder' ,3);
  			this.timerTask('comments' ,15);
  		})
