...
export  const register = r => require.ensure([],() => r(require( '@/components/register/register' )), 'register')
...
//commodity
export  const commodity_all = r => require.ensure([], () => r(require('@/components/commodity/commAll')), 'commAll')
export  const new_commodity = r => require.ensure([], () => r(require('@/components/commodity/newCommodity')), 'newComm')
//shop
export  const shop_all = r => require.ensure([], () => r(require('@/components/shop/shopAll')), 'shopAll')
export  const shop_detail = r=> require.ensure([], () => r(require('@/components/shop/detail')), 'shopDetail')
